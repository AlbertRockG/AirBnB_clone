...
class BaseModel:
    ...
    def __init__(self, *args, **kwargs):
        ...
        Attributes:
            ...
            created_at (time): datetime - assigns the current datetime at creation.
            updated_at (time): datetime - assgns with the current datetime at creation
    ...
    def save(self):
        ...
        """
        self.update_at = datetime.now("%Y-%m-%dT%H:%M:%S.%f")
        models.storage.save()
